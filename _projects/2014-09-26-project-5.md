...
## Overview
Within this project, I was instructed to test multiple sorting algorithms for efficiency on data sets of varying size over the course of thousands to millions of randomized simulated data sets. The goal was to match the most efficient algorithm with their appropriate data set based on size.
